...
impl ParseableDataRecord for SpectralWaveDataRecord {
    fn from_data_row(row: &Vec<&str>) -> Result<SpectralWaveDataRecord, DataRecordParsingError> {
...
mod tests {
    ...
    fn test_spectral_wave_energy_data_row_parse() {
        ...
        let spectral_data = SpectralWaveDataRecord::from_data_row(&data_row).unwrap();
